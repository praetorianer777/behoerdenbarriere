...
// Rund zwanzig Behörden stehen hinter einem Bot-Schutz. Ohne Begründung sähe ihre
// Seite aus wie die einer Behörde, an die noch niemand herangekommen ist.
const gesperrt = {
  ...ungeprueft,
  slug: 'gesperrt',
  name: 'Hinter einer Sperre',
