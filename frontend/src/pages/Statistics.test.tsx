...
describe('Statistik', () => {
  ...
  it('erklärt, was nicht gespeichert wird', async () => {
    ...
    expect(screen.getByText(/Nicht gespeichert werden: IP-Adressen/)).toBeInTheDocument()
  })
  ...
  it('meldet einen leeren Zeitraum, statt Nullen zu zeigen', async () => {
    ...
    expect(
      await screen.findByText('Für diesen Zeitraum liegen noch keine Zahlen vor.'),
    ).toBeInTheDocument()
  })
})
