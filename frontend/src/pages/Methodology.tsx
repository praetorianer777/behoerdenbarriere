export function Methodology() {
  return (
    <div className="max-w-3xl">
      <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Wie wir prüfen</h1>
      ...
      <p className="mt-2">
        Jede Domain veröffentlicht im DNS, welcher Host ihre E-Mail entgegennimmt (MX), wer in ihrem
        Namen senden darf (SPF) und was mit gefälschten Absendern geschehen soll (DMARC). Wir fragen
        diese Einträge ab und ordnen den Host einem Betreiber zu. Abgefragt wird ausschließlich, was
        veröffentlicht ist: kein Portscan, keine Anfrage an einen Mailserver, kein Versuch,
        irgendetwas aufzuzählen.
      </p>
      <p className="mt-4">
        Ein MX-Eintrag sagt, wer die Post <em>annimmt</em> — nicht, wer sie liest. Dahinter kann ein
